...
namespace RimworldExtractorGUI
{
    public partial class FormSettings : Form
    {
        ...
        {
            MessageBox.Show("추출해야 하는 노드의 태그 목록을 정의합니다. '/' 문자로 구분하여 공백 없이 입력합니다.");
        }

        private void buttonHelp2_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Translation Handle은 노드의 이름이 'li'인 리스트 노드를 추출할 때 경우에 따라 사용됩니다.\n" +
        ...
        private void buttonHelp3_Click(object sender, EventArgs e)
        {
            MessageBox.Show("일부 노드는 추출했을 때의 노드와 번역을 적용할 때의 노드가 다른데, 노드 대체 기능은 그러한 경우에 사용됩니다. " +
                            ...
                            "\n주의: Xml로 변환 시에만 적용되며, 아직 'li' 노드가 포함된 경우는 지원하지 않습니다.");
        }

        private void buttonHelp4_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Full-list Translation은 일부 경우에만 사용되는 특수한 번역 데이터 저장 방식입니다. '/' 문자로 구분하여 공백 없이 입력합니다.");
        }
